...
| File | Summary |
| --- | --- |
| [01-add-detailed-skill-output-examples.md](01-add-detailed-skill-output-examples.md) | Skill ごとの詳細なサンプル出力を追加する |
| [02-add-20-department-use-cases.md](02-add-20-department-use-cases.md) | 部門別 use-case をさらに 20 件追加する |
| [03-design-codex-exec-json-eval-cases.md](03-design-codex-exec-json-eval-cases.md) | `codex exec --json` 用の評価ケースを設計する |
| [04-add-sample-excel-templates.md](04-add-sample-excel-templates.md) | サンプル Excel テンプレートを追加する |
| [05-add-sample-word-report-templates.md](05-add-sample-word-report-templates.md) | サンプル Word 報告書テンプレートを追加する |
